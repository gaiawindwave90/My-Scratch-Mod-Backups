...
import {ACCENT_BLUE, ACCENT_MAP, ACCENT_PURPLE, ACCENT_RED, ACCENT_GREEN, ACCENT_PINK, ACCENT_DARKGREEN, ACCENT_NEBULA, ACCENT_COSMIC, ACCENT_AURORA, ACCENT_CHERRY, ACCENT_MINT, ACCENT_RAINBOW, Theme} from '../../lib/themes/index.js';
...
const options = defineMessages({
    ...
    [ACCENT_DARKGREEN]: {
        ...
        id: 'tw.accent.dark-green'
    },
    [ACCENT_NEBULA]: {
        defaultMessage: 'Nebula',
        description: 'Nebula color.',
        id: 'tw.accent.nebula'
    },
    [ACCENT_COSMIC]: {
        defaultMessage: 'Cosmic',
        description: 'Cosmic color.',
        id: 'tw.accent.cosmic'
    },
    [ACCENT_AURORA]: {
    ...
    [ACCENT_CHERRY]: {
        ...
        description: 'Cherry color.',
        id: 'tw.accent.cherry'
    },
    [ACCENT_MINT]: {
        defaultMessage: 'Mint',
        description: 'Mint color.',
        id: 'tw.accent.mint'
    },
    [ACCENT_RAINBOW]: {
